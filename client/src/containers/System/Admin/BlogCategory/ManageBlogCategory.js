...
import { apiGetAllBlogCategory, apiDeleteBlogCategory } from "apis";
...
const ManageBlogCategory = () => {
  ...
  const fetchDataTable = async (searchParam) => {
    await apiGetAllBlogCategory({ ...searchParam, limit: limit })
      .then((res) => {
  ...
  const handleDelete = async (bid) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        await apiDeleteBlogCategory(bid)
          .then((res) => {
            ...
            <div className="iq-card">
              <div className="iq-card-header d-flex justify-content-between">
                <div className="iq-header-title">
                  <h4 className="card-title">Manage BlogCategory</h4>
                </div>
                              ...
                              dataTable.map((item, index) => {
                                return (
                                  <tr key={item?._id}>
                                    ...
                                    <td className="mb-0 description-infor-2-line">
                                      {item?.description}
                                    </td>
