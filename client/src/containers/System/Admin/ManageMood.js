...
import { apiDeleteMood, apiGetAllMood } from "../../../apis";
...
const ManageMood = () => {
  ...
  const FetchGetAllMood = async () => {
    await apiGetAllMood(currentPage, limit, sort, fields)
      .then((res) => {
        if (res.data.data && res.data.data?.length > 0) {
          ...
          setisLoading(false);
          Swal.fire("Cảnh báo", "Không có mood được thêm", "warning");
        }
      })
      .catch((err) => {
        setisLoading(false);
              ...
              <div className="iq-card">
                <div className="iq-card-header d-flex justify-content-between">
                  <div className="iq-header-title">
                    <h4 className="card-title">Mood Lists</h4>
                  </div>
                    ...
                    {(mood !== undefined || mood !== null) && (
                      <Fragment>
                        <div id="user-list-page-info" className="col-md-6">
                          Showing 1 to {mood.length} of {counts} entries
                        </div>
