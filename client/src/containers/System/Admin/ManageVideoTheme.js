...
import { apiGetAllThemes, apiDeleteThemes } from "apis";
import { Loading } from "components";
import Swal from "sweetalert2";
import moment from "moment";
const ManageVideoTheme = () => {
              ...
              <div className="iq-card">
                <div className="iq-card-header d-flex justify-content-between">
                  <div className="iq-header-title">
                    <h4 className="card-title">Theme Lists</h4>
                  </div>
                    ...
                    {(themes !== undefined || themes !== null) && (
                      <Fragment>
                        <div id="user-list-page-info" className="col-md-6">
                          Showing 1 to {themes.length} of {counts} entries
                        </div>
...
export default ManageVideoTheme;
